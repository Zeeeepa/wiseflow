...
class TestEventSystem:
    ...
    def test_event_creation(self, event_system):
    ...
    def test_event_to_dict(self, event_system):
    ...
    def test_event_from_dict(self, event_system):
    ...
    def test_subscribe_and_publish_sync(self, event_system):
    ...
    def test_subscribe_to_all_events(self, event_system):
    ...
    def test_unsubscribe_by_source(self, event_system):
    ...
    def test_enable_disable(self, event_system):
    ...
    def test_propagate_exceptions(self, event_system):
    ...
    @pytest.mark.asyncio
    async def test_publish_async(self, event_system):
    ...
    @pytest.mark.asyncio
    async def test_async_callback(self, event_system):
